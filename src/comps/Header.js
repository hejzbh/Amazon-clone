...
const Header = ({allProducts, setAllProducts}) => {
    ...
    const insertProductsFromSearch = productsForDisplay.map(product=><SearchComponent key={nanoid()} title={product.title} src={product.thumbnail} price={product.price}  id={product.id} />);
