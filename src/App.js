...
function App() {
  ...
  // If the user exists the function will retrieve his data (inCart) from API
 ...
 // Checks if the user is logged in
  ...
  // User logged in? Remember (true) and load his data. Not logged in? Remember (false)
  useEffect(()=>{
...
// Local storage for products in CART (basket)
useEffect(()=> {
